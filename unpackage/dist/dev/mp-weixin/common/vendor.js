...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"芯辰微","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!*******************************************************************!*\
  !*** /Users/xiaofeiwu/Documents/my-project/芯辰微/芯辰微小程序/pages.json ***!
  \*******************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 33 */
/*!*********************************************************************!*\
  !*** /Users/xiaofeiwu/Documents/my-project/芯辰微/芯辰微小程序/api/index.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.getProducts = exports.getProductDetail = exports.getManuals = exports.getCompanyInfo = exports.getCategories = exports.getCatalogs = exports.getCarousels = void 0;
// 获取所有产品分类
...
var getCatalogs = function getCatalogs() {
  ...
  return wx.cloud.callContainer({
    ...
    path: '/api/catalogs?categoryId=' + params.categoryId,
    // 填入业务自定义路径和参数，根目录，就是 / 
    method: 'GET',
    // 按照自己的业务开发，选择对应的方法
    header: {
...
var getProducts = function getProducts() {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  var url = params.catalogId ? '/api/products?catalogId=' + params.catalogId : '/api/products';
  return wx.cloud.callContainer({
    config: {
      env: 'prod-3gdwxhfn933cdfa7' // 微信云托管的环境ID
    },
...
var getCarousels = function getCarousels() {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  // 默认只获取状态为active的轮播图
  ...
  return wx.cloud.callContainer({
    ...
    path: "/api/carousels?status=".concat(status),
    // 轮播图接口
    method: 'GET',
    header: {
      'X-WX-SERVICE': 'express-036x' // 服务名称
...
var getManuals = function getManuals() {
  var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  ...
  return wx.cloud.callContainer({
    ...
    path: "/api/manuals?page=".concat(page, "&pageSize=").concat(pageSize),
    // 产品手册接口
    method: 'GET',
    header: {
      'X-WX-SERVICE': 'express-036x' // 服务名称
...
/* 43 */
/*!************************************************************************!*\
  !*** /Users/xiaofeiwu/Documents/my-project/芯辰微/芯辰微小程序/mixins/share.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  onShareAppMessage: function onShareAppMessage(res) {
    ...
    // 构建完整的分享路径
    var path = queryString ? "/".concat(route, "?").concat(queryString) : "/".concat(route);

    // 获取页面标题
    var title = uni.getNavigationBarTitle().title || '产品中心';
    return {
      title: title,
      path: path,
...
/* 44 */
/*!************************************************************************!*\
  !*** /Users/xiaofeiwu/Documents/my-project/芯辰微/芯辰微小程序/utils/common.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.getUnifiedCloudUrl = exports.convertTcbToCosUrl = exports.convertCosToTcbUrl = void 0;
/**
 ...
 */
var convertCosToTcbUrl = function convertCosToTcbUrl(cosUrl) {
  if (!cosUrl) return '';
  ...
  // 提取环境ID和路径
  var regex = /https:\/\/([\w-]+)\.cos\.[\w-]+\.myqcloud\.com(\/.*)/;
  var match = cosUrl.match(regex);
  if (!match) {
    return cosUrl;
  }
  var envId = match[1];
  ...
  // 构建TCB格式的URL
  return "https://".concat(envId, ".tcb.qcloud.la").concat(path);
};
 ...
 */
exports.convertCosToTcbUrl = convertCosToTcbUrl;
var convertTcbToCosUrl = function convertTcbToCosUrl(tcbUrl) {
  if (!tcbUrl) return '';
  ...
  // 提取环境ID和路径
  var regex = /https:\/\/([\w-]+)\.tcb\.qcloud\.la(\/.*)/;
  var match = tcbUrl.match(regex);
  if (!match) {
    return tcbUrl;
  }
  var envId = match[1];
  ...
  // 构建COS格式的URL
  return "https://".concat(envId, ".cos.ap-shanghai.myqcloud.com").concat(path);
};
 ...
 */
exports.convertTcbToCosUrl = convertTcbToCosUrl;
var getUnifiedCloudUrl = function getUnifiedCloudUrl(url) {
  if (!url) return '';
...
exports.getUnifiedCloudUrl = getUnifiedCloudUrl;
...
/* 123 */
/*!***************************************************************************************************************!*\
  !*** /Users/xiaofeiwu/Documents/my-project/芯辰微/芯辰微小程序/uni_modules/zb-table/components/zb-table/js/summary.js ***!
  \***************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
